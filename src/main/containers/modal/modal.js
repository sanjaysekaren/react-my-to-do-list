...
class ModalItem extends React.Component {
    constructor(props) {
        ...
        this.state = {
            date: this.props.itemDetails.createdDate,time:this.props.itemDetails.createdTime,
    ...
    handleEditInput = () => {
        this.props.handleEditItemToList(this.props.itemDetails.itemId,this.state.itemName,this.state.date,this.state.time)
    }
    getModalStyle = () => {
        const top = 50
        const left = 50
                ...
                >
                    <div style={this.styles.modalStyle} className='paperStyle'>
                        <div className='editModelStyle'>
                            <TextField required id="ItemNameField" autoFocus label="Enter Item Name"
                                variant="outlined" value={this.state.itemName} onChange={this.handleItemName} />
                        </div>
                        <Grid container>
